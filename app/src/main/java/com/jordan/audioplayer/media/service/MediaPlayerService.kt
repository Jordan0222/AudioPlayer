...
import com.jordan.audioplayer.media.exoplayer.MediaPlayerNotificationManager
...
class MediaPlayerService: MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        val sessionActivityIntent = packageManager?.getLaunchIntentForPackage(packageName).let { sessionIntent ->
    ...
    override fun onLoadChildren(
        ...
        when (parentId) {
            K.MEDIA_ROOT_ID -> {
                ...
                if (!resultSent) {
                    // if mediaItem is not fully loaded, suspend
                    result.detach()
                }
            }
            else -> Unit
    ...
    inner class AudioMediaPlayBackPreparer: MediaSessionConnector.PlaybackPreparer {
        ...
        override fun onPrepareFromMediaId(
            ...
            mediaSource.whenReady {
                val itemToPlay = mediaSource.audioMediaMetaData.find { it.description.mediaId == mediaId }
        ...
        override fun onPlaybackStateChanged(playbackState: Int) {
            when (playbackState) {
                Player.STATE_BUFFERING, Player.STATE_READY -> {
                    ...
                    mediaPlayerNotificationManager.hideNotificationManager()
                }
            }
        }
